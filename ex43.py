...
class Death(Scene):
    ...
    quips = [
        ...
        "Such a loser.",
        "I have as mall puppy that's better at this.",
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            You're running down the central corridor to the Weapons Armory when a Gothon jumps out, red scaly skin, dark frimy teeth, and eveil clown costume flowing around his hate filled body. He's blocking the door to the Armory and about to pull a weapon to blast you.
            """))
